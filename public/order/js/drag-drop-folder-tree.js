...
************************************************************************************************************/	
	...
	function JSDragDropTree()
	{
		...
		this.filePathRenameItem = 'content/saveTree';
		this.filePathDeleteItem = 'content/saveTree';
...
JSTreeObj.ajaxObjects[ajaxIndex].setVar("lang", lang);
...
//document.location=document.location;
		...
		{
			//if(this.ajaxObjects[ajaxIndex].response!='OK'){	alert('ERROR WHEN TRYING TO RENAME NODE: ' + this.ajaxObjects[ajaxIndex].response); } else {}
			document.getElementById("poruka").innerHTML = this.ajaxObjects[ajaxIndex].response ;
		}
		,
		__saveTextBoxChanges : function(e,inputObj)
		{
			...
			if(inputObj.value.length>0){
				...
				JSTreeObj.ajaxObjects[ajaxIndex].setVar("action", "renameCategory");
		...
		initTree : function()
		{
			...
			if(this.deleteAllowed || this.renameAllowed){
				try{
					...
					//menuModel.addItem(3,'Visible','','',false,'JSTreeObj.visibleItem');
					//menuModel.addItem(4,'Invisible','','',false,'JSTreeObj.invisibleItem');
