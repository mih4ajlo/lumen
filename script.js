...
var parseDoc = function(index) {
		...
		cont['showCont' + index].each(function() {var $this = $(this); $this.html($this.html().replace(/&nbsp;/g, ''));});
...
function dropHelperNav( event, ui ) {
	...
	if(draggable.attr('id').indexOf("showCont") < 0) {alert("Ovde mozete prevuci samo polja iz LEVE NAVIGACIJE.");return;}
