...
<body>
    ...
    <div class="socialCont">
        ...
        <a href="https://twitter.com/intent/tweet?text= &tw_p=tweetbutton&url="
           onclick="javascript:window.open( this.href +  window.location.href + '&original_referer=' +  window.location.href , '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
